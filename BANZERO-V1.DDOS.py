...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+""+Fore.GREEN+" Send Attack " + str((until - datetime.datetime.now()).total_seconds()) + " ")
        else:
            stdout.flush()
            stdout.write("\r "+Fore.MAGENTA+"[*]"+Fore.GREEN+" Attacking send done !                                   \n")
            return
#ua
...
##############################################################################################
def get_info_l7():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"URL MỤC TIÊU     "+Fore.LIGHTBLUE_EX+": "+Fore.LIGHTYELLOW_EX)
    target = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"CHỦ ĐỀ  "+Fore.LIGHTBLUE_EX+": "+Fore.LIGHTYELLOW_EX)
    thread = input()
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"THỜI GIAN(s)  "+Fore.LIGHTBLUE_EX+": "+Fore.LIGHTYELLOW_EX)
    t = input()
    return target, thread, t

def get_info_l4():
    stdout.write("\x1b[38;2;255;20;147m • "+Fore.WHITE+"IP       "+Fore.LIGHTBLUE_EX+": "+Fore.LIGHTYELLOW_EX)
    target = input()
...
def title():
    ...
    stdout.write("                   "+Fore.LIGHTBLUE_EX  +"██████╦╝██║░░██║██║░╚███║███████╗███████╗██║░░██║╚█████╔╝░░░░░░░░╚██╔╝░░███████╗\n")
    stdout.write("                   "+Fore.LIGHTBLUE_EX  +"╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝╚══════╝╚══════╝╚═╝░░╚═╝░╚════╝░░░░░░░░░░╚═╝░░░╚══════╝\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"           𝙘𝙤𝙙𝙚 𝙗𝙮 𝘿𝙪𝙘𝘼𝙣𝙝\n") 
    stdout.write("                   "+Fore.LIGHTWHITE_EX  +"\n")
    stdout.write("             "+Fore.LIGHTRED_EX        +"      CONTACTS : \n")
    stdout.write("             "+Fore.LIGHTYELLOW_EX+"\n")
    ...
    stdout.write("             "+Fore.LIGHTYELLOW_EX+" "+Fore.LIGHTWHITE_EX   +"       Mail : ducanhcoder@gmail.com    "+Fore.LIGHTRED_EX +"          \n")
    stdout.write("             "+Fore.LIGHTYELLOW_EX+" "+Fore.LIGHTWHITE_EX   +"       Type [Open Panel] Để Hiển Thị Panel    "+Fore.LIGHTRED_EX +"          \n")
...
def command():
    ...
    if command == "cls" or command == "clear":
        clear()
        title()
    elif command == "Open Panel" or command == "?":
        help()
    elif command == "credit":
        credit()        
